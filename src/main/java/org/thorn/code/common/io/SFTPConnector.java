 ...
 *
 * @author chenyun by 2018-06-25 10:45
 * @since JDK1.6
 */
public class SFTPConnector {
     ...
     */
    public SFTPConnector(String userName, String password, String ftpServer) {
     ...
     * @param port  端口号
     */
    public SFTPConnector(String userName, String password, String ftpServer, int port) {
