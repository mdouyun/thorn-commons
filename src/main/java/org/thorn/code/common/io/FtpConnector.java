 ...
 *
 * @author chenyun by 2018-06-25 10:42
 * @since JDK1.6
 */
public class FtpConnector {
    ...
    public FtpConnector(String userName, String password, String ftpServer) {
    ...
    public FtpConnector(String userName, String password, String ftpServer, int port) {
